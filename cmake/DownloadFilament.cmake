...
elseif(APPLE)
    # On macOS/iOS, respect CMAKE_OSX_ARCHITECTURES for cross-compilation
    if(CMAKE_SYSTEM_NAME STREQUAL "iOS")
...
elseif(ANDROID)
    set(FILAMENT_LIB_DIR "${FILAMENT_SDK_DIR}/lib/${CMAKE_ANDROID_ARCH_ABI}")
    if(NOT EXISTS "${FILAMENT_LIB_DIR}")
        set(FILAMENT_LIB_DIR "${FILAMENT_SDK_DIR}/lib/arm64-v8a")
    endif()
else()
    set(FILAMENT_LIB_DIR "${FILAMENT_SDK_DIR}/lib/${CMAKE_SYSTEM_PROCESSOR}")
    if(NOT EXISTS "${FILAMENT_LIB_DIR}")
